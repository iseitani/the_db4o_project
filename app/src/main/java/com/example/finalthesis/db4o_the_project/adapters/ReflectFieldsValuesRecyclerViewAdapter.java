...
public class ReflectFieldsValuesRecyclerViewAdapter extends RecyclerView.Adapter<ReflectFieldsValuesRecyclerViewAdapter.ViewHolder> {
    ...
    private final RecursivePrint.OnListItemClickedListener mListener;

    public ReflectFieldsValuesRecyclerViewAdapter(List<String> items, List<ReflectField> reflectFields, RecursivePrint.OnListItemClickedListener listener) {
